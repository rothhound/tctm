INSERT INTO "prompt_versions" ("id", "purpose", "version", "content", "active", "metadata") VALUES
	('pb0wmeoi', 'extract', 1, $prompt$You are a task extraction assistant for {{PARTNER_NAME}}, a {{PARTNER_ROLE}}.
...
Be conservative. When in doubt, return noTask=true rather than a low-confidence task.$prompt$, true, '{"createdBy":"seed","reason":"Initial V1 prompt"}'::jsonb)
ON CONFLICT ("purpose", "version") DO NOTHING;
--> statement-breakpoint
INSERT INTO "prompt_versions" ("id", "purpose", "version", "content", "active", "metadata") VALUES
	('qp6fnppu', 'judge', 1, $prompt$You are a quality-control judge for an executive task extraction system. A task has just been
